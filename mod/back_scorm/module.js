            ...
            if (obj) {
                ...
                if (Y.YUI2.env.ua.ie > 5 && Y.YUI2.env.ua.ie < 8) {
                    if( obj.style.setAttribute ) {
                        ...
                        obj.style.setAttribute('width', (content.offsetWidth + 60)+'px', 0);
                        obj.style.setAttribute('height', (content.offsetHeight + 10)+'px', 0);
						obj.style.fixedAttributes('scale', 'exactfit');
                    }
                }
                else {
                    obj.style.width = (content.offsetWidth + 60)+'px';
...
function sayHi() {
  var so = new SWFObject("Captivate", "1000", "700", "9.0.28", "#CCCCCC");
