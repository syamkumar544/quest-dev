...
class grade_import_mapping_form extends moodleform {
    ...
    function definition () {
        ...
        $maptooptions = array('username'=>'username', 'userid'=>'userid', 'useridnumber'=>'useridnumber', 'useremail'=>'useremail', '0'=>'ignore');
