<?php
class block_view_grades extends block_base {
    public function init() {
        $this->title = get_string('view_grades', 'block_view_grades');
    }
    ...
    public function get_content() {
        ...
        if($mycourses) {
            ...
            foreach ($mycourses as $course) {
               ...
               $text .= "<li>";
               $text .= "<a href='".$CFG->wwwroot."/grade/report/user/index.php?id=".$course->id."'>".$course->fullname."</a>";
               $text .= "</li>";
               /*$export_text .= "<li>";
